...
namespace ASP_MVC.Areas.admin.Controllers
{
    ...
    public class KhoController : Controller
    {
        ...
        public ActionResult Index(string searchString, int page = 1, int pagesize = 20)
        {
            ...
            return View(model.OrderByDescending(x => x.Status).ToPagedList(page, pagesize));
        }
        ...
        [HttpGet]
        public ActionResult PhieuXuatKho(string searchString, int page = 1, int pagesize = 20)
        {
        ...
        [HttpGet]
        public ActionResult CreatePhieuXuatKho(string searchString, int page = 1, int pagesize = 20)
        {
            ...
            ViewBag.DSDungcu = model.Where(x => x.Status == 1).OrderBy(x => x.ID).ToPagedList(page, pagesize);
            return View();
        }
        ...
        [HttpGet]
        public ActionResult CTPhieuXuatKho(int idphieuxuat, string searchString, int page = 1, int pagesize = 20)
        {
            ...
            ViewBag.DSDungcu = db.KhoVatDungs.Where(x => x.Status == 1).OrderBy(x => x.ID).ToPagedList(page, pagesize);
