...
namespace ASP_MVC.Areas.admin.Controllers
{
    ...
    public class MayChoThueController : Controller
    {
        ...
        public ActionResult LichSuSuaChua(int idmay, string ngaybd, string ngaykt, int page = 1, int pagesize = 20)
        {
            ViewBag.IDmay = idmay;
        ...
        public ActionResult LichSuChoThue(int idmay, string ngaybd, string ngaykt, int page = 1, int pagesize = 20)
        {
            ViewBag.IDmay = idmay;
            List<LichSuMay> listlichSuMays = new List<LichSuMay>();
            var rs = from ml in db.MayLanhs
