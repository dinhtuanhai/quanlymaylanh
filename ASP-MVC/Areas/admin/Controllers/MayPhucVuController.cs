...
namespace ASP_MVC.Areas.admin.Controllers
{
    ...
    public class MayPhucVuController : Controller
    {
        ...
        // GET: admin/MayBaoTri
        public ActionResult Index(long idkh, string searchString, int page = 1, int pagesize = 20)
        {
            ...
            return View(rs.OrderBy(x => x.ID).ToPagedList(page, pagesize));
        }
        [HttpGet]
        ...
        public ActionResult LichSuSuaChua(int idkh, int idmay, string ngaybd, string ngaykt, int page = 1, int pagesize = 20)
        {
            ViewBag.IDmay = idmay;
            ...
            ViewBag.KH = db.KhachHangs.Find(idkh);
            return View(listlichSuMays.OrderBy(x => x.Ngaythuchien).ToPagedList(page, pagesize));
        }
        ...
        public ActionResult Import(FormCollection formCollection, int idkh)
        {
                        ...
                        try
                        {
                            ...
                            foreach (DataRow item in dt.Rows)
                            {
                                ...
                                else
                                {
                                    ...
                                    return View("Index", db.MayLanhs.ToPagedList(1, 20));
                                }
                            }
                            ...
                            if (ModelState.IsValid)
                            {
                                if (list != null)
                                {
                                    ...
                                    var modelss = orderbyList.ToPagedList(1, 20);
            ...
            var models = orderbyList.ToPagedList(1, 20);
