...
namespace ASP_MVC.Areas.admin.Controllers
{
    ...
    public class VatTuController : Controller
    {
                        ...
                        try
                        {
                            ...
                            foreach (DataRow item in dt.Rows)
                            {
                                ...
                                if (String.IsNullOrEmpty(item["Đơn giá"].ToString()))
                                {
                                    ...
                                    dvsp.GiaBan = float.Parse(item["Đơn giá"].ToString());
        ...
        [HttpPost]
        public JsonResult TaoCTPhieuNhap(int idpn, int idvattu, float soluong, float dongia, string ncc, string ghichu)
        {
            ...
            {
                vt.GiaBan = (vt.SoLuong.Value * vt.GiaBan.Value + soluong * dongia) / (vt.SoLuong + soluong);
        ...
        [HttpPost]
        public JsonResult TaoPhieuXuat_KTV(int idktv,int idycpv, string ghichu)
        {
        ...
        [HttpPost]
        public JsonResult TaoPhieuXuat_Khach(string tenKH, string ghichu)
        {
